...
DESCRIPTION:	This program constructs a message using long method, then sends the 					message to a receiver, then deconstructs the reply message using the 					long method and then prints the message contents to the screen. The 					message contents are binary in nature.
